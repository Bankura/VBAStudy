Attribute VB_Name = "WinApiVariables"
Option Explicit


'*/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
'*
'* [機能名] WindowsAPI関連定義モジュール
'* [詳  細] WindowsAPI関連の定数・列挙体・構造体を定義する。
'*
'* [参  考]
'*
'* @author Bankura
...
Public Enum VariantTypeEnum
    ...
    VT_HRESULT = 25          ' An HRESULT or COM return value.
    ...
    VT_VOID = 24             ' A C-style void type.
End Enum
...
'  */
Public Const ENUM_ALL_CALENDARS = &HFFFFFFFF            '  enumerate all calendars
'
'  *  Calendar ID Values.
'  */
...
Public Const HGDI_ERROR As LongPtr = -1 ' -1 Long (&HFFFFFFFF) on 32-bit VBA; -1 LongPtr (&HFFFFFFFFFFFFFFFF^) on 64-bit VBA
...
Public Const WM_RASDIALEVENT = &HCCCD
...
Public Const CBR_BLOCK As LongPtr = -1 ' -1 Long (&HFFFFFFFF) on 32-bit VBA; -1 LongPtr (&HFFFFFFFFFFFFFFFF^) on 64-bit VBA
...
Public Const MAX_JOYSTICKOEMVXDNAME = 260  '  max oem vxd name length (including NULL)
...
Public Const IME_REGWORD_STYLE_USER_LAST = &HFFFFFFFF
...
Public Const BATTERY_LIFE_UNKNOWN = &HFFFFFFFF
...
Public Type CONTEXT
        ...
        VectorControl As LongPtr
        
        ' Special debug control registers
        DebugControl As LongPtr
        LastBranchToRip As LongPtr
        LastBranchFromRip As LongPtr
        LastExceptionToRip As LongPtr
        LastExceptionFromRip As LongPtr
End Type
